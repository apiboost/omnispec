...
:::info[Pro]
The GraphQL renderer requires **[Apiboost OmniSpec Pro](https://apiboost.com/omnispec?utm_source=omnispec&utm_medium=docs&utm_campaign=pro)**. In the free core, GraphQL specs display a styled upgrade prompt.
:::
...
:::info[Pro]
The SOAP/WSDL renderer requires **[Apiboost OmniSpec Pro](https://apiboost.com/omnispec?utm_source=omnispec&utm_medium=docs&utm_campaign=pro)**. In the free core, WSDL specs display a styled upgrade prompt.
:::
...
:::info[Pro]
The gRPC/Protobuf renderer requires **[Apiboost OmniSpec Pro](https://apiboost.com/omnispec?utm_source=omnispec&utm_medium=docs&utm_campaign=pro)**. In the free core, `.proto` specs display a styled upgrade prompt.
:::
